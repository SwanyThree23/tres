      ...
      <div className="relative z-10">
        ...
        <header className="relative">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 pt-20 pb-32 text-center">
            ...
            <p
              ...
              style={{ fontSize: "18px" }}
            >
              The next-generation creator platform with multi-panel streaming,
              AI co-host, real-time translation, and instant monetization — all
              in one place.
            </p>
        ...
        <section id="features" className="max-w-7xl mx-auto px-6 py-24">
          <div className="text-center mb-16">
            ...
            >
              Professional broadcasting tools, AI-powered engagement, and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {tiers.map((t) => (
              <div
                ...
                style={
                  t.badge ? { border: `1px solid ${t.color}33` } : undefined
                }
              >
                {t.badge && (
                  <div
        ...
        <section className="max-w-4xl mx-auto px-6 py-24 text-center">
          ...
          <p
            ...
            style={{ color: "var(--text-muted)" }}
          >
            Join thousands of creators who have already made the switch. No
