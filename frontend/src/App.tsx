...
const App: React.FC = () => {
    ...
    const [greenRoomAction, setGreenRoomAction] = useState<'watch' | 'panel' | 'browse' | undefined>(undefined);
    ...
    const renderContent = () => {
        switch (activeTab) {
            case 'home': return <Dashboard initialAction={greenRoomAction} />;
                ...
                {!hasInteracted && (
                    <GreenRoom 
                        onEnter={(config) => {
                            ...
                            addNotification('Live Staging Complete', 'Entry parameters synchronized.');
                        }}
                    />
                )}
            </AnimatePresence>
